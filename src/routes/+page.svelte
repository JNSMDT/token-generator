...
<div class="app bg-sky-300 font-mono flex flex-col h-100svh w-100svw items-center p-10">
	...
	<main class="mb-20 flex flex-1 flex-col gap-10 relative justify-center items-center">
		...
		<div class="password-section">
			...
			<h2 class="password bg-sky-50 rounded-2 text-4xl font-bold p-8">{@html highlightedPassword}</h2>
		</div>
		...
		>
			...
			<div class="flex flex-col gap-2">
				...
				<div class="special-characters">
					<input bind:value={ inputSpecialChars }
						class="px-1 border-b-2 border-slate-400 w-50"
						id="special-characters"
						type="text" />
					<button class="px-1 border-1 border-black w-1lh"
			...
			<button class="px-2 py-1 mt-5 bg-sky-500 rounded-2 font-bold" onclick={ saveSettings } type="button">Save Settings</button>
		</div>
	</main>
	<Signature />
</div>
